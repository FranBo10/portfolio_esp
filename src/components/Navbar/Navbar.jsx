    ...
    <Container id="home" maxWidth="xl" class="dark:text-gray-200">
      <Toolbar disableGutters>
        ...
        <div class="detalle-nav">
          <ul class="hidden lg:flex cursor-pointer items-center">
            <Link smooth to="#about">
              <li class="ml-10 text-sm uppercase">Acerca de mí</li>
            </Link>
            <Link smooth to="#skills">
              <li class="ml-10 text-sm uppercase">Competencias</li>
            </Link>
            <Link smooth to="#projects">
              <li class="ml-10 text-sm uppercase">Proyectos</li>
            </Link>
            <Link smooth to="#services">
              <li class="ml-10 text-sm uppercase">Servicios</li>
            </Link>
            <Link smooth to="#contact">
              <li class="ml-10 text-sm uppercase">Contacto</li>
            </Link>
            <li class="ml-10 text-sm uppercase">
              <button class="px-2 rounded text-xl text-white hover:scale-105 ease-in duration-300 bg-teal-600 font-medium">
                <a href="https://franbo10.github.io/cv_esp/">Mi CV</a>
              </button>
            </li>
          </ul>
        </div>
        <div class=" z-[10]">
          ...
          >
            <div
              class={
                nav
                  ? "lg:hidden fixed left-0 top-0 w-[75%] sm:x-[60%] lg:w-[45%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500 z-[100]"
            ...
            >
              <div>
                ...
                <div class="border-b border-gray-300 my-4">
                  <p class="w-[85%] lg:w-[90%] py-">
                    Creemos algo juntos y que sea legendario
                  </p>
                </div>
              </div>
