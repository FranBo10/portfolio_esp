  ...
  return (
    <div id="projects" class="w-full">
      <div class="max-w-[1240px] m-auto px-2 my-16">
        ...
        <h2 class="py-4 dark:text-gray-100">Mis proyectos</h2>
        <div class="grid md:grid-cols-2 gap-8">
          <ProjectItem
            title="Pizzeria Popine"
            description="Aplicación web PHP Symfony / Javascript (2024)"
            backgroundImg={popine}
            projectUrl="https://popineparis.osc-fr1.scalingo.io/"
          />
          <ProjectItem
            title="FreetourGo"
            description="Aplicación web PHP Symfony / Javascript (2023)"
            backgroundImg={freetourgo}
            projectUrl="https://freetourgo.com"
          />
          <ProjectItem
            title="T-Shop (E-Commerce)"
            description="PHP / Symfony / Bootstrap - Aplicación básica de comercio electrónico con Bootstrap (2022)"
            backgroundImg={tshop}
            projectUrl="https://t-shop.osc-fr1.scalingo.io/"
          />
          <ProjectItem
            title="Karnak Porcellanato"
            description="Primer proyecto HTML / CSS (2020)"
            backgroundImg={karnak}
            projectUrl="https://franbo10.github.io/karnak/"
          />
          <ProjectItem
            title="Pokedex"
            description="React / Vite - Conexión a PokeAPI, visualización y sistema de búsqueda de Pokémon (2021)"
            backgroundImg={pokedex}
            projectUrl="https://franbo10.github.io/pokedex_js/"
          />
          <ProjectItem
            title="Continúa Formándote"
            description="PHP / WordPress - Uso de LearnPress, Ultimate Member y Stripe (2022)"
