...
const Cards = () => {
  return (
    <div id="servicios" class="w-full p-2 my-16">
      <div>
        ...
        <p class="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
          ...
          trabajado de forma remota para agencias, startups y empresas,
          colaborando con diversos talentos para crear productos digitales que
          satisfagan tanto las necesidades profesionales como las del público en
          general.
        </p>
        <p class="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
          Ofrezco una amplia gama de servicios, que incluyen diseño de marca,
          programación y una constante actualización tecnológica.
        </p>
      </div>
      <div class="lg:flex gap-10 text-gray-800">
        <div class="text-center shadow-xl shadow-gray-400 p-1 border-2 rounded-xl hover:scale-105 ease-in duration-300 my-5 dark:bg-gray-200 flex-1">
          <img
            ...
            class="mx-auto"
          />
          <h3 class="text-lg font-medium border-b inline-block border-black">
            Hermosos diseños
          </h3>
          <p class="py-2">
            Creación de diseños elegantes adaptados a sus necesidades siguiendo
            la teoría básica del diseño.
          </p>
          <h4 class="pt-2 pb-1">Herramientas de diseño que utilizo:</h4>
          <ul>
        ...
        <div class="text-center shadow-xl shadow-gray-400 p-1 border-2 rounded-xl hover:scale-105 ease-in duration-300 my-5 dark:bg-gray-200 flex-1">
          ...
          <p class="py-2">
            Una actualización tecnológica constante garantizará que su
            aplicación esté siempre al día.
          </p>
          <h4 class="pt-2 pb-1">Sitios para mantenerse actualizado:</h4>
          <ul>
            <li class="py-1">- Documentación oficial</li>
